...
export const emailAdapter = {
    async sendConfirmationCode(email: string, confirmationCode: string, userId: number) {
        ...
        Щоб підтвердити адрес електронної пошти перейдіть за наступним посиланням: <a href="http://localhost:${config.PORT}/registration/confirmEmail/${confirmationCode}?userId=${userId}">Посилання (Натисніть на цей текст)</a>
